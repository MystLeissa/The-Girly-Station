...
/obj/machinery/mineral/equipment_vendor
	...
	var/list/prize_list = list( //if you add something to this, please, for the love of god, sort it by price/type. use tabs and not spaces.
		...
		new /datum/data/mining_equipment("Rope",						/obj/item/rope,														200),
		...
		new /datum/data/mining_equipment("Mining Conscription Kit",		/obj/item/storage/backpack/duffelbag/mining_conscript,				1200),
		...
		new /datum/data/mining_equipment("3x Mining Implants",			/obj/item/storage/backpack/satchel/minerimplants,					3000)
		)
